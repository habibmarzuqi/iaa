  ...
  const handleClick = (n: NotifItem) => {
    ...
    if (n.link) {
      ...
      const viewMap: Record<string, any> = {
        ...
        'admin-cert-templates': { name: 'admin-cert-templates' },
        'admin-events': { name: 'admin-events' },
        'admin-members': { name: 'admin-members' },
        'admin-inbox': { name: 'admin-inbox' },
        'admin-cms': { name: 'admin-cms' },
        'admin-files': { name: 'admin-files' },
        'admin-reports': { name: 'admin-reports' },
        'admin-settings': { name: 'admin-settings' },
        'admin-site-settings': { name: 'admin-site-settings' },
        'admin-menu': { name: 'admin-menu' },
