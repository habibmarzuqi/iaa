...
const DEFAULT_SETTINGS: Record<string, { value: string; type: string; category: string }> = {
  ...
  'hero.style': { value: 'carousel', type: 'select', category: 'general' },
...
Berdedikasi|Menjaga memori kolektif bangsa untuk generasi mendatang`,
  ...
  'about.stats.stat1Value': { value: '2,400+', type: 'text', category: 'about' },
  'about.stats.stat1Label': { value: 'Anggota Aktif', type: 'text', category: 'about' },
  'about.stats.stat2Value': { value: '180+', type: 'text', category: 'about' },
  'about.stats.stat2Label': { value: 'Kegiatan / Tahun', type: 'text', category: 'about' },
  'about.stats.stat3Value': { value: '5,600+', type: 'text', category: 'about' },
  'about.stats.stat3Label': { value: 'Sertifikat Terbit', type: 'text', category: 'about' },
  'about.stats.stat4Value': { value: '1,200+', type: 'text', category: 'about' },
  'about.stats.stat4Label': { value: 'Koleksi Digital', type: 'text', category: 'about' },
